      ...
      <StyledContainer>
        <div style={{ marginTop: "2rem", maxWidth: "1040px" }}>
          ...
          <p>
            ...
            in our Privacy Policy. We are compliant with the General Data
            Protection Regulation (GDPR). We only collect necessary personal
            data and ensure the utmost security in processing and storing this
            data.
          </p>
          ...
          <h3>3. License</h3>
          <p>
            Unless otherwise stated, [Your Website Name] owns the intellectual
          ...
          <p>
            Any claim related to [Your Website Name]'s website shall be governed
            by the laws of the UK without regard to its conflict of law
            provisions.
          </p>
          ...
          <p>
            ...
            contact us at using the form provided{" "}
            <a href="victorblanco.co.uk/contact">here</a>.
          </p>
        </div>
      </StyledContainer>
    </MainContainer>
